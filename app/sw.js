 ...
 *   app.js  APP_VERSION = '0.9.10'
 *   sw.js   SW_VERSION   = 'sidekick-v0.9.10'
 ...
 */
const SW_VERSION = 'sidekick-v0.9.10';
...
const SHELL_ASSETS = [
  ...
  BASE + 'index.html',
  BASE + 'login.html',
  BASE + 'app.js?v=0.9.10',
  BASE + 'tax.js?v=0.9.10',
  BASE + 'invoices.js?v=0.9.10',
  BASE + 'docgen.js?v=0.9.10',
  BASE + 'bookings.js?v=0.9.10',
  BASE + 'followups.js?v=0.9.10',
  BASE + 'portfolio.js?v=0.9.10',
  BASE + 'research.js?v=0.9.10',
  BASE + 'styles.css?v=0.9.10',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
