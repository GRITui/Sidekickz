 ...
 *   app.js  APP_VERSION = '0.8.1'
 *   sw.js   SW_VERSION   = 'freelanz-v0.8.1'
 ...
 */
const SW_VERSION = 'freelanz-v0.8.1';
...
const SHELL_ASSETS = [
  ...
  BASE + 'app.js?v=0.8.1',
  BASE + 'tax.js?v=0.8.1',
  BASE + 'invoices.js?v=0.8.1',
  BASE + 'docgen.js?v=0.8.1',
  BASE + 'bookings.js?v=0.8.1',
  BASE + 'followups.js?v=0.8.1',
  BASE + 'portfolio.js?v=0.8.1',
  BASE + 'research.js?v=0.8.1',
  BASE + 'styles.css?v=0.8.1',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
