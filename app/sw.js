 ...
 *   app.js  APP_VERSION = '0.8.7'
 *   sw.js   SW_VERSION   = 'freelanz-v0.8.7'
 ...
 */
const SW_VERSION = 'freelanz-v0.8.7';
...
const SHELL_ASSETS = [
  ...
  BASE + 'app.js?v=0.8.7',
  BASE + 'tax.js?v=0.8.7',
  BASE + 'invoices.js?v=0.8.7',
  BASE + 'docgen.js?v=0.8.7',
  BASE + 'bookings.js?v=0.8.7',
  BASE + 'followups.js?v=0.8.7',
  BASE + 'portfolio.js?v=0.8.7',
  BASE + 'research.js?v=0.8.7',
  BASE + 'styles.css?v=0.8.7',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
