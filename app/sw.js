 ...
 *   app.js  APP_VERSION = '0.9.30'
 *   sw.js   SW_VERSION   = 'sidekick-v0.9.30'
 ...
 */
const SW_VERSION = 'sidekick-v0.9.30';
...
const SHELL_ASSETS = [
  ...
  BASE + 'index.html',
  BASE + 'login.html',
  BASE + 'app.js?v=0.9.30',
  BASE + 'dataClient.js?v=0.9.30',
  BASE + 'tax.js?v=0.9.30',
  BASE + 'invoices.js?v=0.9.30',
  BASE + 'docgen.js?v=0.9.30',
  BASE + 'bookings.js?v=0.9.30',
  BASE + 'followups.js?v=0.9.30',
  BASE + 'portfolio.js?v=0.9.30',
  BASE + 'research.js?v=0.9.30',
  BASE + 'styles.css?v=0.9.30',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
