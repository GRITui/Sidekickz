 ...
 *   app.js  APP_VERSION = '0.9.43'
 *   sw.js   SW_VERSION   = 'sidekick-v0.9.43'
 ...
 */
const SW_VERSION = 'sidekick-v0.9.43';
...
const SHELL_ASSETS = [
  ...
  BASE + 'index.html',
  BASE + 'login.html',
  BASE + 'app.js?v=0.9.43',
  BASE + 'dataClient.js?v=0.9.43',
  BASE + 'tax.js?v=0.9.43',
  BASE + 'invoices.js?v=0.9.43',
  BASE + 'docgen.js?v=0.9.43',
  BASE + 'bookings.js?v=0.9.43',
  BASE + 'followups.js?v=0.9.43',
  BASE + 'portfolio.js?v=0.9.43',
  BASE + 'research.js?v=0.9.43',
  BASE + 'styles.css?v=0.9.43',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
