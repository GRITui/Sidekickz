 ...
 *   app.js  APP_VERSION = '0.8.4'
 *   sw.js   SW_VERSION   = 'freelanz-v0.8.4'
 ...
 */
const SW_VERSION = 'freelanz-v0.8.4';
...
const SHELL_ASSETS = [
  ...
  BASE + 'app.js?v=0.8.4',
  BASE + 'tax.js?v=0.8.4',
  BASE + 'invoices.js?v=0.8.4',
  BASE + 'docgen.js?v=0.8.4',
  BASE + 'bookings.js?v=0.8.4',
  BASE + 'followups.js?v=0.8.4',
  BASE + 'portfolio.js?v=0.8.4',
  BASE + 'research.js?v=0.8.4',
  BASE + 'styles.css?v=0.8.4',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
