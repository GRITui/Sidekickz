 ...
 *   app.js  APP_VERSION = '0.8.2'
 *   sw.js   SW_VERSION   = 'freelanz-v0.8.2'
 ...
 */
const SW_VERSION = 'freelanz-v0.8.2';
...
const SHELL_ASSETS = [
  ...
  BASE + 'app.js?v=0.8.2',
  BASE + 'tax.js?v=0.8.2',
  BASE + 'invoices.js?v=0.8.2',
  BASE + 'docgen.js?v=0.8.2',
  BASE + 'bookings.js?v=0.8.2',
  BASE + 'followups.js?v=0.8.2',
  BASE + 'portfolio.js?v=0.8.2',
  BASE + 'research.js?v=0.8.2',
  BASE + 'styles.css?v=0.8.2',
  BASE + 'manifest.json',
  BASE + 'icons/icon.svg',
